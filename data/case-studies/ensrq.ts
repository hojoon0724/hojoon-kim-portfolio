...
export const ensrq: CaseStudy = {
  id: "ensrq",
  title: "enSRQ",
  roleTag: "Designer who builds operational systems",
  caseStudyOf:
    "Designer-who-codes case: visual identity + operational tools in one system",
  description:
  ...
  bulletPoints: [
    ...
    "Replaced rigid CMS constraints with a custom multi-season architecture",
    "Built internal admin workflows for concerts, artists, programs, and notes",
    "Created a single source of truth across public and operational content",
  ],
  toolsIds: [
    "vs-code",
    "react",
  ...
  date: "2018-present",
  careerSignal:
    "I can evolve public brand expression and internal operational tooling as one coherent system.",
  oneLiner:
  ...
  proofPoints: [
    {
      ...
      detail:
        "Evolved the brand from credibility-focused early years to a confident and approachable season voice.",
    },
    {
      label: "Platform decision",
      detail:
        "Moved from CMS constraints to a custom structure that preserves each season's look and history.",
    },
    {
      label: "Operational impact",
      detail:
        "Centralized program, artist, and concert content into a single system for accuracy and speed.",
    },
  ],
  pageFlow: [
    {
    ...
    },
    {
      ...
      photoDirection: [
        "Season-by-season visual timeline",
        "Before/after identity examples",
      ],
    ...
    },
    {
      ...
      photoDirection: [
        "Old folder-based workflow snapshot",
        "New structured dashboard and content model",
      ],
    ...
    },
    {
      ...
      photoDirection: [
        "Cards for concerts, artists, programs, bios, and notes modules",
    ...
    },
    {
      ...
      photoDirection: [
        "Strong text-first section with subtle texture background",
      ],
  ...
  sections: [
    {
      ...
      visualNarrative:
        "Set up a side-by-side of visual identity pressure and operations pressure.",
      suggestedAssets: [
    ...
    },
    {
      ...
      visualNarrative:
        "Use an exploded view showing front-end experience connected to admin data fields.",
      suggestedAssets: [
        "Public page screenshots",
        "Admin panel screenshots",
        "Content model schema or table",
      ],
    },
    {
      id: "impact",
      ...
      visualNarrative:
        "Close with proof cards that connect brand quality to operational reliability.",
      suggestedAssets: [
