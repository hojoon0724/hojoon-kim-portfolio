...
export const rcnm: CaseStudy = {
  id: "rocket-city-new-music",
  title: "Rocket City New Music",
  roleTag: "0-to-1 founder and systems builder",
  caseStudyOf:
    "0-to-1 founder build across strategy, systems, operations, and experience",
  description:
  ...
  bulletPoints: [
    ...
    "Created fundraising, donor, and partner communication systems",
    "Designed and operated branding, ticketing, finance, and CRM workflows",
    "Led cross-functional production across <d></d>esign, tech, and live experience",
  ],
  toolsIds: [
    "vs-code",
    "figma",
  ...
  date: "2021-2025",
  careerSignal:
    "I can create structure under ambiguity and scale a mission with limited resources.",
  oneLiner:
  ...
  proofPoints: [
    {
      ...
      detail:
        "Launched with minimal initial budget and no established infrastructure.",
    },
    {
      label: "Systems ownership",
      detail:
        "Implemented interconnected workflows for donor relations, finance, artists, and production.",
    },
    {
      label: "Long-term durability",
      detail:
        "Organization continued to thrive after transition, validating systems and leadership model.",
    },
  ],
  pageFlow: [
    {
    ...
    },
    {
      ...
      photoDirection: [
        "Concert photos with lighting and staging details",
        "Program design, posters, and media stills",
      ],
    ...
    },
    {
      ...
      photoDirection: [
        "Text-forward ending section with one strong portrait or stage photo",
      ],
  ...
  sections: [
    {
      ...
      visualNarrative:
        "Use a startup-style opening board with constraints and objectives.",
      suggestedAssets: [
        "Early budget sheet",
        "Donor outreach notes",
        "First season concept slide",
      ],
    },
    {
      id: "execution",
      ...
      visualNarrative:
        "Present a layered architecture: audience layer, operations layer, infrastructure layer.",
      suggestedAssets: [
        "Website screenshots",
    ...
    },
    {
      ...
      visualNarrative:
        "Close with three proof cards and one strong quote over a performance photo.",
      suggestedAssets: [
