...
export function EnsrqBarrelRollBrochure() {
  ...
  return (
    <div className="ensrq-barrel-roll-brochure-container relative mx-auto flex max-w-200 flex-col items-center">
      <div ref={frameRef} className="brochure-frame relative h-120 w-[calc(100%-6rem)]">
        <div
        ...
        >
          <div className="brochure-outside-page flex flex-row cursor-pointer" onClick={close}>
      ...
      <div className="page-turn-indicators absolute inset-0 lg:opacity-0 hover:opacity-60 flex items-center justify-between">
        <div
          className="close-indicator flex h-16 w-16 items-center justify-center cursor-pointer"
          onClick={close}
        >
          &#9664;
        </div>
        <div
          className="open-indicator flex h-16 w-16 items-center justify-center cursor-pointer"
          onClick={open}
        >
          &#9654;
        </div>
