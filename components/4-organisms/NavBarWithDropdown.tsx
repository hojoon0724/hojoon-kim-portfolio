...
export function NavBarWithDropdown() {
  ...
  return (
    <div className="nav-container fixed bottom-0 flex justify-end items-end w-full z-50 px-0 py-0 lg:bottom-auto lg:top-0 lg:px-0 lg:py-0">
      ...
      >
        <nav
          className={`flex items-start lg:items-center flex-col w-full lg:flex-row justify-start lg:justify-between backdrop-blur-lg rounded-t-lg lg:rounded-lg bg-surface-heavy/40 text-on-heavy transition-transform duration-500 lg:h-nav h-auto lg:py-0 px-0 relative`}
        >
          <div className="nav-left flex items-center h-full w-full lg:w-auto">
            <div className="lg:hidden">
              <div className="mobile-menu-toggle-container h-nav w-nav bg-surface-accent rounded-tl-lg flex items-center justify-center cursor-pointer">
          ...
          <ul
            className={`flex flex-col lg:justify-center items-center w-full lg:flex-row lg:items-stretch h-full py-3xl lg:py-0 gap-lg lg:gap-0 w-fit lg:w-auto px-8 lg:px-0 transition-transform duration-500`}
          >
            {navItems.map((item, index) => {
              if (item.isCta) {
                ...
                return (
                  ...
                  >
                    <div
                      className="dropdown-name h-full hidden lg:flex flex-row-reverse lg:flex-row justify-end -ml-7 items-center gap-sm cursor-pointer px-md"
